...
public class EmployeeClass extends PersonClass {
    ...
    public EmployeeClass(int document, String name, String email, int salary,JobPositionClass job_position) {
            ...
            switch (option) {
                case 1:
                    ...
                    for (int i = 1; i <= num_employees; i++) {
                        ...
                        EmployeeClass employee = new EmployeeClass(document, name, email, salary, job);
                ...
                case 2:
                    ...
                    for (int i = 0; i < employee_list.size(); i++) {
                        ...
                        System.out.println(ANSI_BLUE + "Cargo: " + ANSI_RESET + job.getName_job());
                        System.out.println(ANSI_BLUE + "Jerarquía: " + ANSI_RESET + job.getHerarchy_job());
                    }
                    break;
                case 3:
                    ...
                    if (index >= 0 && index <= employee_list.size()) {
                        ...
                        switch (edit_field) {
                            ...
                            case 5:
                                ...
                                job.setName_job(job_p);
                                break;
                            case 6:
                                System.out.println(ANSI_PURPLE + "Área nuevo" + ANSI_RESET);
                                String herarchy_p = inst_datos.nextLine();
                                job.setHerarchy_job(herarchy_p);
                                break;
                            default:
